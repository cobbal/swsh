...
extension FDOperationTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__FDOperationTests = [
        ("testFDRawRepresentable", testFDRawRepresentable),
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(FDOperationTests.__allTests__FDOperationTests),
